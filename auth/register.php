...
if (isset($_POST['submit'])) {
  ...
  // checking for empty field value
  if (empty($_POST['username']) or empty($_POST['email']) or empty($_POST['password'])) {
    ...
    // saving fields into database
    $query = $connection->prepare('INSERT INTO users (username, email, mypassword) VALUES (:username, :email, :mypassword)');
